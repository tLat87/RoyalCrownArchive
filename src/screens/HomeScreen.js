...
const HomeScreen = ({navigation}) => {
    const dynasties = [
        { name: 'BOURBONS',facts:['Louis XIV - “Sun King”, construction of Versailles.', 'Restoration of monarchy after Napoleon.', 'Influence: Absolutism, centralization of power.'], origin: 'Founded by Robert de Clermont (13th century), a branch of the Capetings', country: 'France, Spain, Luxembourg, Naples\n' +
                'Origin: Founded by Robert de Clermont (13th century), branch of the Capetings', type: 'Political', period: 'Early Modern Age, Enlightenment', image: require('../assets/img/cc/Rectangle3.png') },
    ...
    return (
        <View style={styles.container}>
            <View style={{flexDirection: 'row', justifyContent: 'space-around'}}>
                <Text style={styles.header}>HOUSES & DYNASTIES</Text>
